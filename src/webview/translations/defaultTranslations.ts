...
export const defaultTranslations = {
    ...
    'Use cron expressions': 'Use cron expressions',
    ...
    'Day Cron': 'Day Cron',
    'Night Cron': 'Night Cron',
    'Use standard 5-field cron syntax, e.g., 0 6 * * *': 'Use standard 5-field cron syntax, e.g., 0 6 * * *',
    'Invalid cron expression': 'Invalid cron expression',
    'Cron expression is required': 'Cron expression is required',
    'Cron expression syntax is invalid': 'Cron expression syntax is invalid',
    'Please fix cron expression errors before saving': 'Please fix cron expression errors before saving'
};
